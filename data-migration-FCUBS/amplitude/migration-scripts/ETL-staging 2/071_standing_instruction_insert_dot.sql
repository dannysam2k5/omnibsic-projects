...
select * from ertb_msgs where err_code ='SI-DEF-004';--SI-VALS-035
...
delete from Cstb_Ext_Contract_Stat where source = 'SI_UPD';
...
Begin
 FOR I IN (SELECT DISTINCT BRANCH_CODE FROM CSTB_EXT_CONTRACT_STAT WHERE FUNCTION_ID='SIDTRONL' AND IMPORT_STATUS='U')
   LOOP
     global.pr_init(I.BRANCH_CODE, 'MIG_USER01');--Change Branch Code here
